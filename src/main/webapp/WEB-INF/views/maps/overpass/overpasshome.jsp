...
<div class="wrapper">
    <div class="sidebar">
        <h2>CSGO Tactics</h2>
        <ul>
            <li><a href="overpass/ct"><i class="fas fa-home"></i>CT tactics</a></li>
            <li><a href="overpass/terro"><i class="far fa-map"></i>T tactics</a></li>
            <%--            <br/>--%>
            <%--            <br/>--%>
    ...
    <div class="main_content">
        ...
        <div class="info">
            <%--@elvariable id="overpassTactics" type="java.util.List<babinski.sebastian.model.Tactic"--%>
            <c:forEach items="${overpassTactics}" var="tactic">
