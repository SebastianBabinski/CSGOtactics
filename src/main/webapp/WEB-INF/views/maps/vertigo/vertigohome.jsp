...
<div class="wrapper">
    <div class="sidebar">
        <h2>CSGO Tactics</h2>
        <ul>
            <li><a href="vertigo/ct"><i class="fas fa-home"></i>CT tactics</a></li>
            <li><a href="vertigo/terro"><i class="far fa-map"></i>T tactics</a></li>
            <%--            <br/>--%>
            <%--            <br/>--%>
